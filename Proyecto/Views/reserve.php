...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    listadoOpiniones.forEach(element => {
      divOpiniones.innerHTML = divOpiniones.innerHTML + '<div class="rounded d-flex justify-content-center  "> <div class="shadow-lg p-5 bg-light div-partidos" ><div class="row"><div class="col-md-5"><img alt="Imagen de un trofeo representando que es un torneo" src="../img/soccer-tournament.jpg" ?>" class="img-rounded" /> </div> <div class="col-md-5"><h2> ' + element[fecha] + '</h2><p>Tipo: ' + element[tipo_reserva] + ' </p> <p> Lugar: ' + element[localidad] + '  </p>     <p>          Tipo partido: ' + element[tipo_cancha] + '   </p>   <p>     Hora: ' + element[hora] + '  </p>   <p>   Organizador: ' + element[nombre] + '   </p>    </div>   <div class="col-md-2">  <a href="../Controller/asistir_partido.php" ?>" type="button" class="btn btn-primary boton-partidos">   ASISTIR   </a>  </div>   </div>   </div>  </div>';
